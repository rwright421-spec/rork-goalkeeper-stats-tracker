...
function createStyles(c: ThemeColors) {
  return StyleSheet.create({
    ...
    subHeaderText: { fontSize: 13, color: c.textMuted, fontWeight: '500' as const },
    ...
    tabText: { fontSize: 14, fontWeight: '600' as const, color: c.textMuted },
    ...
    switchText: { fontSize: 13, color: c.textSecondary, fontWeight: '600' as const },
    ...
    finalScoreTitle: { fontSize: 14, fontWeight: '700' as const, color: c.textSecondary, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 16, textAlign: 'center' },
    scoreRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 20 },
    scoreTeam: { alignItems: 'center', flex: 1 },
    scoreTeamLabel: { fontSize: 11, fontWeight: '700' as const, color: c.textMuted, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8 },
    scoreValue: { fontSize: 36, fontWeight: '800' as const },
    scoreInput: { fontSize: 36, fontWeight: '800' as const, color: c.text, textAlign: 'center', backgroundColor: c.surface, borderRadius: 12, borderWidth: 1, borderColor: c.border, paddingHorizontal: 16, paddingVertical: 6, minWidth: 80 },
    scoreDash: { fontSize: 28, fontWeight: '300' as const, color: c.textMuted },
    ...
    editInfoSummary: { fontSize: 12, color: c.textSecondary, fontWeight: '500' as const, maxWidth: 160 },
    editInfoTitle: { fontSize: 13, fontWeight: '700' as const, color: c.textMuted, textTransform: 'uppercase', letterSpacing: 1 },
    editInfoContent: { marginTop: 14 },
    editInputGroup: { marginBottom: 12 },
    editInputLabel: { fontSize: 12, color: c.textSecondary, fontWeight: '600' as const, marginBottom: 6 },
    editInput: { backgroundColor: c.background, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, color: c.text, fontSize: 15, borderWidth: 1, borderColor: c.border },
