...
function createStyles(c: ThemeColors) {
  return StyleSheet.create({
    ...
    title: { fontSize: fontSize.display2, fontWeight: '800' as const, color: c.text, letterSpacing: -0.5 },
    subtitle: { fontSize: fontSize.body, color: c.textSecondary, fontWeight: '500' as const, marginTop: 2 },
    ...
    actionText: { flex: 1, fontSize: fontSize.subtitle, fontWeight: '700' as const, color: c.text },
    createForm: { backgroundColor: c.surface, borderRadius: 14, padding: 16, borderWidth: 1.5, borderColor: c.primary },
    createLabel: { fontSize: fontSize.body2, fontWeight: '600' as const, color: c.textSecondary, marginBottom: 8 },
    createInput: { backgroundColor: c.surfaceLight, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, color: c.text, fontSize: fontSize.subtitle, borderWidth: 1, borderColor: c.border, marginBottom: 12 },
    ...
    guestText: { fontSize: fontSize.subtitle, fontWeight: '700' as const, color: c.text },
    guestSubtext: { fontSize: fontSize.caption, color: c.textMuted, fontWeight: '500' as const, marginTop: 1 },
    profilesHeader: { flexDirection: 'row' as const, alignItems: 'center' as const, paddingHorizontal: 20, marginBottom: 12, gap: 8 },
    profilesTitle: { flex: 1, fontSize: fontSize.bodyLg, fontWeight: '700' as const, color: c.textSecondary },
    profilesCount: { fontSize: fontSize.body2, fontWeight: '600' as const, color: c.textMuted, backgroundColor: c.surface, paddingHorizontal: 10, paddingVertical: 3, borderRadius: 10, overflow: 'hidden' as const },
    ...
    profileInitial: { fontSize: fontSize.h3, fontWeight: '800' as const, color: c.primary },
    profileInfo: { flex: 1 },
    profileNameRow: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: 6 },
    profileName: { fontSize: fontSize.subtitle, fontWeight: '600' as const, color: c.text, flexShrink: 1 },
    profileDate: { fontSize: fontSize.caption, color: c.textMuted, marginTop: 2 },
