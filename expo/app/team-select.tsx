...
function createStyles(c: ThemeColors) {
  return StyleSheet.create({
    ...
    profileName: { fontSize: fontSize.body, fontWeight: '700' as const, color: c.primaryLight },
    sectionInstruction: { fontSize: fontSize.body, color: c.textSecondary, fontWeight: '500' as const },
    ...
    createButtonText: { flex: 1, fontSize: fontSize.subtitle, fontWeight: '700' as const, color: c.text },
    createForm: { backgroundColor: c.surface, borderRadius: 14, padding: 16, borderWidth: 1.5, borderColor: c.primary },
    fieldLabel: { fontSize: fontSize.body2, fontWeight: '600' as const, color: c.textSecondary, marginBottom: 8 },
    input: { backgroundColor: c.surfaceLight, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, color: c.text, fontSize: fontSize.subtitle, borderWidth: 1, borderColor: c.border, marginBottom: 12 },
    ...
    yearText: { fontSize: fontSize.subtitle, color: c.text, fontWeight: '500' as const },
    ...
    allGamesText: { fontSize: fontSize.subtitle, fontWeight: '700' as const, color: c.text },
    allGamesSubtext: { fontSize: fontSize.caption, color: c.textMuted, fontWeight: '500' as const, marginTop: 1 },
    teamsHeader: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 20, marginBottom: 12, gap: 8 },
    teamsTitle: { flex: 1, fontSize: fontSize.bodyLg, fontWeight: '700' as const, color: c.textSecondary },
    teamsCount: { fontSize: fontSize.body2, fontWeight: '600' as const, color: c.textMuted, backgroundColor: c.surface, paddingHorizontal: 10, paddingVertical: 3, borderRadius: 10, overflow: 'hidden' },
    ...
    teamBadgeText: { fontSize: fontSize.body2, fontWeight: '800' as const, color: c.primary },
    teamInfo: { flex: 1 },
    teamName: { fontSize: fontSize.subtitle, fontWeight: '600' as const, color: c.text },
    teamMeta: { fontSize: fontSize.caption, color: c.textMuted, marginTop: 2 },
    ...
    emptyTitle: { fontSize: fontSize.h4, fontWeight: '600' as const, color: c.textSecondary, marginTop: 8 },
    emptySubtitle: { fontSize: fontSize.body2, color: c.textMuted },
  });
}
